...
<?php  
    ...
    if (!isset($_SESSION['username_visited'])) {
        $_SESSION['username_visited'] = 1;
        echo "You Have Visited " . $_SESSION['username_visited'] ." Times (FROM SESSION)";
    } else {
        $value = $_SESSION['username_visited'];
        $value++;
        $_SESSION['username_visited'] = $value;
        echo "<script> alert('WELCOME BACK YOU VISITED $value Times FROM SESSION') </script>";
    }
...
<body bgcolor="#f4f4f4" onunload="showGif()" onload="checkCookie()">
    ...
    <div class="upc">
        <section class="section-upcoming-cars">
            ...
            <div class="upcoming-car" onmouseover="enlarge(this)" onmouseout="small(this)">
                ...
                <img class="car-small-image" src="BMW-X7-Left-Front-Three-Quarter-145764%20.jpg">
                
                <span class="car-name common-attributes">BMW X7</span>
                
                <span class="car-price common-attributes"> &#8377 80 Lakhs - 1.2 Crores</span>
            ...
            <div class="upcoming-car" onmouseover="enlarge(this)" onmouseout="small(this)">
                ...
                <img class="car-small-image" src="BMW-New-3-Series-Exterior-140779.jpg">
                
                <span class="car-name common-attributes">BMW New 3 Series</span>
                
                <span class="car-price common-attributes"> &#8377 50 - 60 Lakhs</span>
                <span class="est common-attributes">Estimated Price</span>
                
                <span class="est-date common-attributes"> 21st August 2019 </span>
                <span class="est common-attributes">Estimated Launch</span>
    ...
    <center>
        ...
        <button type="button" class="btn" onclick="loadDoc()"> Get Cars </button>
        <br><br>
